...
def create_output_path(input_folder: str) -> str:
    ...
    # input_files/book_title/chapter# から output_files/book_title/book_title__chapter#.txt を生成 #noqa: E501
    ...
    if len(parts) >= 3 and parts[0] == "input_files":
        ...
        raise ValueError(
            "入力フォルダは 'input_files/book_title/chapter#' の形式である必要があります" #noqa: E501
        )
